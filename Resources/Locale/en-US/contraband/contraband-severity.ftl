...
contraband-examine-text-Restricted-department = [color=yellow]This item is restricted to {$department}, and may be considered contraband.[/color]
contraband-examine-text-Restricted-department-minor = [color=yellow]This item is restricted to {$department}, and may be considered minor contraband.[/color]
contraband-examine-text-Restricted-department-major = [color=red]This item is restricted to {$department}, and may be considered major contraband.[/color]
